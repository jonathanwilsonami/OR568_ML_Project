...
Our analytical dataset was constructed by integrating multiple aviation and environmental data sources into a unified preprocessing and feature-engineering pipeline. The primary data sources for this project were:
...
### Why the BWI–EWR Market Pair (keep? Might be focusig on the wider nation but to keep things simple we did start with a market pair)
